...
import DoneAnim from "../../../public/done-anim.json";
...
const LBService = () => {
  ...
  return (
    <main className="flex min-h-screen  w-full h-auto flex-col items-center justify-center p-6 lg:px-24 lg:pt-24 bg-gray-100">
      <Header />
      {succeeded ? (
        <div className="flex flex-col items-center justify-center w-full h-[700px] lg:h-[1000px]">
          <div className="flex flex-col items-center justify-center w-full h-full ">
            ...
            />
            <h1 className="text-3xl font-bold">신청해주셔서 감사드립니다.</h1>
            <p className="text-md lg:text-xl mt-4">
              제출하신 이메일 혹은 연락처로 연락드리겠습니다.
            </p>
          </div>
        </div>
      ) : (
        <div className="flex flex-col w-full sm:w-full lg:w-[1000px] items-center">
          ...
          <div className="flex flex-col items-center md:mx-0">
            ...
            <h1 className="md:text-2xl text-lg font-light text-center mt-4 text-gray-700">
              아웃소싱 개발의 A부터 Z까지 여러분의 프로젝트를 위한 맞춤형
              길잡이가 되어드릴게요.
            </h1>
            ...
            <div className="flex flex-col w-full lg:w-96 ">
              ...
              <input
                ...
                name="phone"
                id="phone"
                className="flex text-black transition-colors placeholder:text-muted focus:outline-none focus:ring-1 focus:ring-black focus:placeholder:text-gray-8 text-md px-4 py-3 h-[--input-size-lg] rounded-full border mt-4"
              ...
              <a
                ...
                className={`border border-transparent inline-flex justify-center items-center rounded-full outline-none gap-[.3em] disabled:pointer-events-none ${
                  !email || !phone
                    ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                    : "bg-black text-white text-canvas hover:bg-primary/75 data-[state=open]:bg-primary/75 transition-colors"
                } text-base py-3 px-6 w-full`}
                onClick={() => {
                  if (email && phone) handleSubmit();
                }}
              >
              ...
              <button
                className="btn bg-black text-white mt-8 rounded-full"
